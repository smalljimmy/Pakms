...
namespace ICP.Controls.PrintableListView
{
    ...
    public class DocumentPaginatorExtention : DocumentPaginator
    {
        ...
        public DocumentPaginatorExtention(PrintableListView listview, Thickness margin, Size printPageArea)
        {
            ...
            ListCollectionView originalData = (ListCollectionView)listview.ItemsSource;
            CollectionViewSource source = new CollectionViewSource();
            source.Source = (listview.ItemsSource as ListCollectionView).SourceCollection;
        ...
        /*
        public override int PageMargin
        {
        ...
        protected virtual DocumentPage CreatePage(int pageNumber)
        {
            ...
            if (printableListView.Group != null && printableListView.Group.GroupDescriptions != null)
            {
                FrameworkElement body = printableListView.Group.Render(printableListView, printableListView.DataContext, sourceView, printableListView.ReportBody, 50, ref itemIndex, rect, out list);
