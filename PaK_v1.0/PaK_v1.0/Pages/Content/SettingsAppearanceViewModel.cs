...
namespace PaK_v1._0.Content
{
        ...
        : NotifyPropertyChanged
    {
        ...
        public SettingsAppearanceViewModel()
        {
            ...
            //this.themes.Add(new Link { DisplayName = "pascha", Source = new Uri("/PaK_v1.0;component/assets/pascha.xaml", UriKind.Relative) });
        ...
        public Link SelectedTheme
        {
            ...
            set
            {
                if (this.selectedTheme != value)
                {
                    ...
                    //persistent theme to user profile
                    customPrincipal.Identity.Theme = value.ToString();
        ...
        public string SelectedFontSize
        {
            ...
            set
            {
                if (this.selectedFontSize != value)
                {
                    ...
                    //persistent fontsize to user profile
                    customPrincipal.Identity.Fontsize = value.ToString();
        ...
        public Color SelectedAccentColor
        {
            ...
            set
            {
                if (this.selectedAccentColor != value)
                {
                    ...
                    //persistent color to user profile
                    customPrincipal.Identity.Color = value.ToString();
